...
/**
 * Maps the mailbox-model status classes (is-success / is-error / is-warning /
...
/** The status-pill logic stays in mailbox-model; it renders as a Semi Tag. */
export function MailboxStatusTag({ className, children }: { className: string; children: ReactNode }) {
