...
_SAFE_RUNTIME_ERROR_CODES = frozenset(
    {
        ...
        "document_ocr_not_configured",
        "document_ocr_request_failed",
        "document_ocr_rate_limited",
        "document_ocr_ai_gateway_failed",
        "document_ocr_empty_response",
        "document_ocr_auth_failed",
        "document_ocr_request_invalid",
        "document_ocr_invalid_response",
        "document_ocr_image_open_failed",
        "document_ocr_invalid_image",
        "document_ocr_image_prepare_failed",
        "document_ocr_image_too_large",
        "document_ocr_image_dimensions_too_large",
        "document_ocr_invalid_page",
        "document_ocr_page_render_failed",
